        ...
        <custom:ValidationGroupPanel runat="server" ValidationGroup="AddVolunteer">
            <asp:Table runat="server">
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <custom:TextBox runat="server" ID="txt_title" Required="True" Title="Title"></custom:TextBox></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        ...
                        <custom:DropDownList runat="server" ID="ddl_category" Required="True" Title="Category">
                            <Items>
                                <asp:ListItem Text="Inpatient Programs" Value="Inpatient Programs"></asp:ListItem>
                                <asp:ListItem Text="Outpatient Programs" Value="Outpatient Programs"></asp:ListItem>
                                <asp:ListItem Text="Additional Programs" Value="Additional Programs"></asp:ListItem>
                            </Items>
                        </custom:DropDownList>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <custom:TextBox runat="server" ID="txt_description" Required="True" TextMode="MultiLine"
                            Height="100px" Width="100px" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>Post Date</asp:TableCell>
                    <asp:TableCell>
                        <custom:DateBox runat="server" ID="txt_postdate" Required="True" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>End Date</asp:TableCell>
                    <asp:TableCell>
                        <custom:DateBox runat="server" ID="txt_enddate" Required="True" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
